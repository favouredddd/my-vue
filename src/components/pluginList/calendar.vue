<template>
  <div class="plugin-type el-plugin-type">
    ...
    <div class='plugin-item'>
      <div class="plugin-content el-plugin-06001" style="height: 320px;display: block">
      ...
      <div class='plugin-explain'>
        ...
        <br>
        <p class='explain'>这是一个输入时间的输入框插件，通过点击输入框，自动弹出日历，日历智能获取当前时间。
          通过点击弹出的日历上的日期，来选取相应的时间。
          本插件可自定义配置项包括：背景颜色、表头颜色、本月颜色、今日颜色、他月颜色。</p>
      </div>
    </div>
  </div>
</template>
<script>
	import dateInput1 from '@/components/pluginlist/dateInput/dateInput1.vue'
	export default {
		name:"dataInput",
		data(){
			return {name:"日期选择"}
