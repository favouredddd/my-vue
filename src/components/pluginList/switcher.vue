<template>
  <div class="plugin-type el-plugin-type">
    ...
    <div class='plugin-item'>
      <div class="plugin-content el-plugin-12001">
            <switcher1 />
      </div>
      <br>
      ...
      <div class='plugin-explain'>
        ...
        <br>
        <p class='explain'>这是一款模仿苹果开关的switcher插件，通过点击进行开关变换。使用插件时需设置插件渲染容器父元素的宽度、高度，switcher插件根据父元素宽度、高度自适应设置自己的高度、宽度，本插件可自定义配置项包括：打开颜色、关闭颜色、按钮颜色。</p>
      </div>
    </div>
    <div class='plugin-item'>
      <div class="plugin-content el-plugin-12002">
        <div class="plugin-switcher-2">
            <switcher1 />
        </div>
      </div>
      <br>
      ...
      <div class='plugin-explain'>
        <p class="instruction-title-sec">插件说明:</p>
        <br>
        <p class='explain'>这是一个3D switch插件，通过点击实现开关''on''与''off''的转换。本插件可自定义配置项包括：打开颜色、关闭颜色、背景颜色、字体颜色。</p>
      </div>
    </div>
    <div class='plugin-item'>
      <div class="plugin-content el-plugin-12003">
        <div class="plugin-switcher-3" style="width: 50px;height: 50px;">
      ...
      <div class='plugin-explain'>
        <p class="instruction-title-sec">插件说明:</p>
        <br>
        <p class='explain'>这是一个3D switch插件，通过点击实现开与关以及颜色变化，使用此插件，需给插件渲染容器的父元素设置宽度和高度。本插件可自定义配置项包括：打开颜色、关闭颜色。</p>
      </div>
    </div>
    <div class='plugin-item'>
      <div class="plugin-content el-plugin-12004">
        <div class="nd-plugin-button-1">
      ...
      <div class='plugin-explain'>
        <p class="instruction-title-sec">插件说明:</p>
        <br>
        <p class='explain'>这是本系统的按钮模板插件。
          本插件可自定义配置项包括：一列颜色、二列颜色、三列颜色。</p>
      </div>
    </div>
  </div>
</template>
<script>
import switcher1 from '@/components/pluginlist/switcher/switcher1.vue'
export default {
  name: "switcher",
  data() {
    return { name: "开关" }
